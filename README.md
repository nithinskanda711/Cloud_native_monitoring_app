...
Cost warning. The EKS control plane bills roughly $0.10/hour (~$73/month) whether or not any workload is running, plus EC2 node costs. Delete the cluster when you are not using it — see Teardown.
